...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { description: @reaction.description, dog_id: @reaction.dog_id, rating: @reaction.rating } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { description: @reaction.description, dog_id: @reaction.dog_id, rating: @reaction.rating } }
